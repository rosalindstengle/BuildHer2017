...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script src="./WebGazer_files/highlight.pack.js.download"></script>
...
p > code.hljs { display: inline; }
    ...
    <body data-spy="scroll" data-target="#navbar" waid71fa0d88-5390-4b5b-a2f4-e45fa93d85e2="SA password protect entry checker">
        ...
        <div id="home" class="container pad" style="padding-top: 0px">
            <a href="https://github.com/brownhci/WebGazer"><img style="position: absolute; top: 30; right: 0; border: 0;" src="./WebGazer_files/68747470733a2f2f73332e616d617a6f6e6177732e636f6d2f6769746875622f726962626f6e732f666f726b6d655f72696768745f6f72616e67655f6666373630302e706e67" alt="Fork me on GitHub" data-canonical-src="https://s3.amazonaws.com/github/ribbons/forkme_right_orange_ff7600.png"></a>
            <!-- Main
...
prediction.y; <span class="hljs-comment">//now always in the bounds of the viewport</span>
        ...
        <div id="support" class="container pad">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <center>
                        <img src="./WebGazer_files/chrome.png" alt="Google Chrome" width="100" height="100">
                    </center>
                    <h4 class="text-center">Google Chrome 47+</h4>
                </div>
                <div class="col-lg-3">
                    <center>
                        <img src="./WebGazer_files/edge.png" alt="Microsoft Edge" width="100" height="100">
                    </center>
                    <h4 class="text-center">Microsoft Edge 13+</h4>
                </div>
                <div class="col-lg-3">
                    <center>
                        <img src="./WebGazer_files/firefox.png" alt="Mozilla Firefox" width="100" height="100">
                    </center>
                    <h4 class="text-center">Mozilla Firefox 44+</h4>
                </div>                
                <div class="col-lg-3">
                    <center>
                        <img src="./WebGazer_files/opera.png" alt="Opera" width="100" height="100">
                    </center>
...
./build_library</code></pre>
        ...
        <div id="contact" class="container pad">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <img class="img-circle center-block" src="./WebGazer_files/alexpap.jpg" alt="Alexandra Papoutsaki" height="140">
                ...
                <div class="col-lg-3">
                    <img class="img-circle center-block" src="./WebGazer_files/jim.jpg" alt="James Laskey" height="140">
                    <h4 class="text-center">James Laskey</h4>
                    <p>Software Enginner at Google. Graduated from Brown in 2016.</p>
                </div>
                <div class="col-lg-3">
                    <img class="img-circle center-block" src="./WebGazer_files/aaron.jpg" alt="Aaron Gokaslan" height="140">
                    <h4 class="text-center">Aaron Gokaslan</h4>
                    <p>Undergraduate student at Brown University.</p>
                </div>                
                <div class="col-lg-3">
                    <img class="img-circle center-block" src="./WebGazer_files/jeff-hs.jpg__90x120_q85_subsampling-2.jpg" alt="Jeff Huang" height="140">
        ...
        <script src="./WebGazer_files/jquery.min.js.download"></script>
        <script src="./WebGazer_files/bootstrap.min.js.download"></script>
